/*********************************************************
    Name: Age_Column_Names
    Date: 01/31/17

*********************************************************/


IF OBJECT_ID('White.Age.Age_Column_Names','U') IS NOT NULL
DROP TABLE White.Age.Age_Column_Names;
GO

CREATE TABLE Age.Age_Column_Names (
	Age_Column_Names_Key INT IDENTITY(1,1) PRIMARY KEY
	, Age_Column_Names NVARCHAR(100)
)

INSERT INTO Age.Age_Column_Names (
	Age_Column_Names
)
VALUES('White_Male_Under_5')
	,('White_Male_5_To_9')
	,('White_Male_10_To_14')
	,('White_Male_15_To_17')
	,('White_Male_18_To_19')
